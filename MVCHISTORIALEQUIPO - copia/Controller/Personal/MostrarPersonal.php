            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 margen-superior">
                ...
                <table class="table table-ms">
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        $sentencia = $conexion->prepare("select * FROM personalsoporte WHERE Nombres OR Apellidos LIKE ?");
                        ...
                        $sentencia = $conexion->prepare("select * FROM personalsoporte");
                    }
                    ...
                    while ($fila = $sentencia->fetch()) {
                        ...
                        echo '<td>' . $fila['DNI'] . '</td>';
                        echo ("<td>" . obtenerUsuario($fila['CodigoUsuario']) . "</td>");
                        echo '<td>' . '<a href="ModificarPersonal.php?Codigo=' . $fila['Codigo'] . '" class="btn btn-danger">Modificar</a>' . '</td>';
                        echo '</tr>';
                    }
                    ...
                    {
                        require("../../Model/conexion.php");
                        $sql = "select Nombre from Usuario where Codigo = ?";
